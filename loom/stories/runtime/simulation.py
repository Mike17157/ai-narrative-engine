...
# In the unified model the per-thread record is a State doc (loom/stories/runtime_state.py)
...
def sim_of(state: dict | None) -> dict:
    ...
    from .runtime.state import get_level
...
def with_sim(state: dict | None, sim_state: dict) -> dict:
    ...
    from .runtime.state import set_level
