...
DEFAULT_SYSTEMS = {
    "storyboard": (
        "You are a story architect — part structural engineer, part dramatist. You "
        ...
        "scene gets an eerie stillness. 1-2 plain, concrete sentences — the place, the light, the "
        "weather; no ornate or painterly language.\n\n"
        ...
        "passages.\n\n"
        "LOCATIONS: give EACH chapter a SPECIFIC, concrete setting with its own identity. Avoid "
        ...
        "no people, plain and concrete, matching this chapter's emotional tone>\n"
        "2. ...\n"
