...
DEFAULT_SYSTEMS = {
    ...
    "protagonist": (
        ...
        "the MAIN CHARACTER.\n\n"
        "Write `persona` as a well-structured character card. PRESERVE the source's own section "
        "structure and headings wherever it already has them. Where the source is unstructured, "
        "organize it into these markdown sections, in order:\n"
        "  >**<Name>: <age> years old**\n"
        ...
        "Keep EVERY concrete detail the source establishes — do NOT omit, summarize away, soften, "
        "or invent. This is the protagonist; stay strictly faithful to the card.\n\n"
