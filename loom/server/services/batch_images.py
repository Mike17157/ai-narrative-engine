...
renders them concurrently against the local ComfyUI GPU (a small thread pool — ComfyUI
serialises on the GPU anyway), reporting per-image progress and honouring cancellation.
...
# --------------------------------------------------------------------------- #
# Per-task provider factory — returns a provider with a FRESH-seeded workflow.
# --------------------------------------------------------------------------- #
def _seed_fn(seed):
