    ...
    <div class="edit">
      ...
      <div class="zone">
        ...
        {#if (sel.lorebooks || []).length}
          <div class="chips">
            {#each sel.lorebooks as id}<a class="chip" href="/lorebooks?book={id}">{bookName(id)}</a>{/each}
          </div>
        {:else}
            ...
            {#each presetScripts as s (s.book + ':' + s.fn)}
              <div class="script">
                <div class="srow">
                  ...
                  <a class="sbook" href="/lorebooks?book={s.book}" title={s.bound ? 'bound to this preset' : 'attached to this preset'}>{s.bookName}</a>
                </div>
      ...
      <div class="zone bound">
        ...
        {#if boundBooks(sel.id).length}
          <div class="chips">
            {#each boundBooks(sel.id) as b}<a class="chip" href="/lorebooks?book={b.id}">{b.name || b.id}</a>{/each}
          </div>
        {:else}
