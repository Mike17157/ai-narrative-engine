<script>
  import { lora, selectedCount, pick, cancelJob, saveSet } from '$lib/lora.svelte.js';
...
{#if !lora.rows.length}
  <div class="empty">
    <div class="hint">No batch yet. Configure prompts under <a href="/images/lora/prompts">Prompts</a> and hit Generate — results appear here, and you can switch around the app anytime while it runs.</div>
  </div>
{:else}
