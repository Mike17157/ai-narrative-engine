<script>
  ...
  import AffectScatter from '$lib/components/story/AffectScatter.svelte';
  import TagInput from '$lib/components/image/TagInput.svelte';
  import RegenModal from '$lib/components/image/RegenModal.svelte';
