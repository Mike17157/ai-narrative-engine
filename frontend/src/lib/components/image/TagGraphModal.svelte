<script>
  ...
  import TagSearch from '$lib/components/image/TagSearch.svelte';
  import FacetPalette from '$lib/components/image/FacetPalette.svelte';
  import TagGraphCanvas from '$lib/components/image/TagGraphCanvas.svelte';
